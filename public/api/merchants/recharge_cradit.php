                    ...
                    {  
                        ...
                        if(!empty($varify['decoded_data'])){
                            ...
                            if (!empty($merchant_id)) {
                                ...
                                $get_user=$user->find_user("merchants","user_ion_id",$merchant_id,$conn); 
                                if(!empty($get_user)){
                                     
                                    // check database if user exist in cradit card so skip the customer creation
                                    
                                    $card_data=$mercharnt->find_cradit_card($data->card_number,$merchant_id,$conn);
                                    ...
                                    if ($card_data) {
                                        ...
                                        $mercharnt->add_card($merchant_id,$data->card_number,$data->exp_month,$data->exp_year,$data->cvc,$customer->id,$conn);
                                    }
                                    if ($charge_success) {

                                      // update cradit of user in database
                                      $mercharnt->update_cradit($merchant_id,$conn);
