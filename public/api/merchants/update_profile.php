        ...
        if (!empty($jwt_key)) {
            try{
                ...
                if(!empty($varify['decoded_data'])){
                    ...
                    if (!empty($varify['decoded_data']->data->user_ion_id)) {    
                        $get_user=$user->find_user("merchants",'user_ion_id',$varify['decoded_data']->data->user_ion_id,$conn);
                        if(!empty($get_user)){
                            ...
                            $user_ion_id=$get_user['user_ion_id'];
